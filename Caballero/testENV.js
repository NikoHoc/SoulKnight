function createVertexBuffer(GL, data) {
  ...
  function main() {
    ...
    var box3 = generateCube(-4, 2, 5, 4, 5, 4, [0.58, 0.42, 0.27]);
    ...
    var animate = function (time) {
      ...
      if (time > 0.8 && time < 2.5) {
      ...
      }else if (time > 10.4 && time < 16) {
        runningKnight14 += deltaTime * 0.08
        ...
        LIBS.translateY(KNIGHT_MODEL_MATRIX, runningKnight14);
        LIBS.translateY(LEGG_KANAN_MATRIX, runningKnight14);
        LIBS.translateY(LEGG_KIRI_MATRIX, runningKnight14);
        LIBS.translateY(MAG_MATRIX, runningKnight14);
