export function generateUfoOutline(a, b, c, segments,translateX,translateY,translateZ
) {
  var vertices = [];
  var colors = [];
...
export function generateUfoYellow(a, b, c, segments, translateX,translateY,translateZ) {
  var vertices = [];
  var colors = [];
